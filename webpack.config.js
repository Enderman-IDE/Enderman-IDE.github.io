    ...
    defaultsDeep({}, base, {
        ...
        plugins: base.plugins.concat([
            ...
            new HtmlWebpackPlugin({
                ...
                template: 'src/playground/index.ejs',
                filename: 'index.html',
                title: 'JoeMod - a mod of PenguinMod',
                ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                chunks: ['fullscreen'],
            ...
            new HtmlWebpackPlugin({
                ...
                title: 'JoeMod, PenguinMod & TurboWarp Credits',
                noSplash: true,
                ...htmlWebpackPluginCommon
            }),
